...
import os
from HW08_Anurag_Aman import file_reader
...
class Repository:
    ...
    def student_grade_summary_pretty_table(self) -> None:
        ...
        for i in self.instructor_table_db('/Users/anuragaman/Desktop/sqlite/810_startup.db'):
            pt.add_row(i)
        
        print(pt)


Repository('/Users/anuragaman/Desktop/student_repository')